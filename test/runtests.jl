...
@time pppfull=TransNet_N(testD, D,1000000.0, 2.0, 1E-6,0.3,5e-7,100000,0;Contact=C)   


@time pppfull=main_function("MN", testD, D,1000000.0, 2.0, 1E-6,0.3,5e-7,1000,0;Contact=C)   
...
@time pppfull=main_function("MNN", testD, D,1000000.0, 2.0, 1E-6,0.3,5e-7,100000,0)   
...
#output the data
CSV.write("/Users/janine/Documents/Phylogenetics/Programming/SimulationData_NetworkBased/Bayesian Results/IMPACT_inf_NetID_Test.csv", inf_Net_ppp_1)
CSV.write("/Users/janine/Documents/Phylogenetics/Programming/SimulationData_NetworkBased/Bayesian Results/IMPACT_Para_Net_Test.csv", Param_ppp_1)
CSV.write("/Users/janine/Documents/Phylogenetics/Programming/Data/BayesianResult 2024/Latent_1.csv", Latent_rd_ppp_1)
