    ...
    elseif size(Pevent, 1) != n | size(Pevent, 2) != n
        ...
        for k in 2:itr_MCMC 
            ...
            if k > burn_in && k%100 == 0
                ...
                println("Iteration ",k,": Loglikelihood ",trunc(sum(ProbNet_event),digits=2),", theta ",theta,", mu ",mu,", inf_rate ",inf_rate)
...
#################################################
# model with network information
#################################################
